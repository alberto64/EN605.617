...
bool CreateMemObjects(cl_context context, cl_mem memObjects[3],
                      float *a, float *b, const int ARRAY_SIZE)
{
...
void operation(const char *cl_name, const char *kernel_name, const int ARRAY_SIZE) {
    ...
    // Create OpenCL program for each operation
    program = CreateProgram(context, device, cl_name);
    ...
    CreateMemObjects(context, memObjects, a, b, ARRAY_SIZE);

    // Set the kernel arguments for each operation (result, a, b)
